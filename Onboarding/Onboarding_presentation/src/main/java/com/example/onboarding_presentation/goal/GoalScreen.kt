...
fun GoalScreen(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = stringResource(id = R.string.lose_maintain_or_gain_weight),
            ...
            Row {
                ...
                SelectableButton(
                    text = stringResource(id = R.string.maintain),
                    isSelected = viewModel.selectedGoal is GoalType.MaintainWeight,
                    color = MaterialTheme.colors.primaryVariant,
                    selectedTextColor = Color.White,
                    onClick = {
                        viewModel.onGoalTypeSelected(GoalType.MaintainWeight)
                    },
                    textStyle = MaterialTheme.typography.button.copy(
                        fontWeight = FontWeight.Normal
                    )
